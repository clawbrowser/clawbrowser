...
- Join the [Clawbrowser Discord](https://discord.gg/DWuwhYZVn) for community discussion.
...
Clawbrowser is open-source software available under the [MIT License](LICENSE).

Copyright © 2026 Clawbrowser contributors.
