  ...
  cat > "${CONFIG_FILE}" <<'JSON'
{
  ...
  "startCommand": "clawctl start --session openclaw-main --",
  "startUrlPlaceholder": "${url}",
  "endpointCommand": "clawctl endpoint --session openclaw-main",
  "rotateCommand": "clawctl rotate --session openclaw-main",
  "verifyCommand": "clawctl start --session openclaw-main -- clawbrowser://verify/",
  "closeBlankTabs": true,
  "notes": [
