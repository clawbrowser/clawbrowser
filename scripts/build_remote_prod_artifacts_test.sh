...
assert_common_success_contract() {
  ...
  assert_contains "${SCENARIO_RUNNER_BODY}" 'run_step fingerprint_contract verify_fingerprint_patch_contract'
  assert_contains "${SCENARIO_RUNNER_BODY}" 'bash scripts/fingerprint_patch_contract_test.sh'
...
run_darwin_success_scenario() {
  ...
  assert_contains "${SCENARIO_RUNNER_BODY}" 'verify_staged_runtime "${stage_dir}"'
...
run_linux_success_scenario() {
  ...
  assert_contains "${SCENARIO_RUNNER_BODY}" '--include="/clawbrowser-fonts/${catalog_id}/***"'
  assert_not_contains "${SCENARIO_RUNNER_BODY}" "--include='/clawbrowser-fonts/***'"
